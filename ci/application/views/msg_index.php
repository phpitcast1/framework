...
<head>
    ...
    <title>微留言演示案例</title>
    <link rel="stylesheet" type="text/css" href="/ci/message/msg.css" media="all" />
</head>
<body id="message" onselectstart="return true;" ondragstart="return false;">
	<div class="container">
	  	<div class="qiandaobanner">
		  	<a href="/ci/message">
		  		<img src="/ci/message/wall.jpg" style="width:100%;" />
		  	</a>
	  	</div>
				...
				<div class="history-date">
					<ul>
						...
						<li class="green bounceInDown">
							<h3>
								<img src="/ci/message/logo100x100.jpg"> 
								<?= $msg['uname'] ?>
								<span>
	...
	<script type="text/javascript" src="/ci/message/jquery.js"></script>
